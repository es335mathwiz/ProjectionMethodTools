...
public class TwoShockMod extends DoEqns{

		 TwoShockMod meFunc(){return(this);}
		...
		EquationValDrv forInt1=PPNxt$tp1.pow(4).times(-1);;
		return(forInt1);}};
		...
		EquationValDrv eqn3=AA$Shock$tm1.times(-1).plus(PPNxt$t).plus(PP$Shock$tm1.times(-1));

...
/*compare 1 true -1 false, size of deriv matrix should match but values derivatives never used set zero*/
    ...
    public EquationValDrv gt(int aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;int jj;
    ...
    public EquationValDrv gt(double aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;
    ...
    public EquationValDrv gt(EquationValDrv anEqValDrv) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	double [][] vv=anEqValDrv.theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    ...
    public EquationValDrv lt(int aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;int jj;
    ...
    public EquationValDrv lt(double aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;
    ...
    public EquationValDrv lt(EquationValDrv anEqValDrv) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	double [][] vv=anEqValDrv.theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    ...
    public EquationValDrv le(int aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;int jj;
    ...
    public EquationValDrv le(double aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;
    ...
    public EquationValDrv le(EquationValDrv anEqValDrv) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	double [][] vv=anEqValDrv.theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    ...
    public EquationValDrv or(int aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;int jj;
    ...
    public EquationValDrv or(double aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;
    ...
    public EquationValDrv or(EquationValDrv anEqValDrv) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	double [][] vv=anEqValDrv.theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    ...
    public EquationValDrv and(int aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;int jj;
    ...
    public EquationValDrv and(double aVal) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
    	int ii;
    ...
    public EquationValDrv and(EquationValDrv anEqValDrv) throws ProjectionRuntimeException{
    	double [][] du=theJac.getArrayCopy();
    	double [][] uu=theVal.getArrayCopy();
    	double [][] vv=anEqValDrv.theVal.getArrayCopy();
    	int numRows=uu.length;int numCols=du[0].length;
 ...
 public EquationValDrv eqvdIf(double lftVal,EquationValDrv rghtEqvd)throws ProjectionRuntimeException {
 	double [][] du=theJac.getArrayCopy();
 	double [][] uu=theVal.getArrayCopy();
 	double [][] rdu=rghtEqvd.theJac.getArrayCopy();
 	double [][] ruu=rghtEqvd.theVal.getArrayCopy();

...
Global`redExport["prettyhapp03ValsA.pdf",happ03ValsAG=
Plot3D @@ {hmatApp03Vals[Global`qtm1,Global`rutm1,0][[2,1]]*(aPath03ValsExtFunc[Global`qtm1,Global`rutm1,0][[5,1]]-.02),{Global`qtm1,Global`qLow,Global`qHigh},{Global`rutm1,Global`ruLow,Global`ruHigh},
PlotRange->All,PlotLabel->
{"\!\(\*SubscriptBox[\(H\), \(2\)]\)[q,r,0]  constraint for two periods"}}//.Global`lucaSubs]

Global`redExport["prettyhapp03ValsB.pdf",happ03ValsBG=
Plot3D @@ {hmatApp03Vals[Global`qtm1,Global`rutm1,0][[5,1]]*(aPath03ValsExtFunc[Global`qtm1,Global`rutm1,0][[8,1]]-.02),{Global`qtm1,Global`qLow,Global`qHigh},{Global`rutm1,Global`ruLow,Global`ruHigh},
PlotRange->All,PlotLabel->
{"\!\(\*SubscriptBox[\(H\), \(5\)]\)[q,r,0]  constraint for two periods"}}//.Global`lucaSubs]


Global`redExport["prettyhapp03ValsC.pdf",happ03ValsCG=
Plot3D @@ {hmatApp03Vals[Global`qtm1,Global`rutm1,0][[8,1]]*(aPath03ValsExtFunc[Global`qtm1,Global`rutm1,0][[11,1]]-.02),{Global`qtm1,Global`qLow,Global`qHigh},{Global`rutm1,Global`ruLow,Global`ruHigh},
PlotRange->All,PlotLabel->
{"\!\(\*SubscriptBox[\(H\), \(5\)]\)[q,r,0]  constraint for two periods"}}//.Global`lucaSubs]
*)

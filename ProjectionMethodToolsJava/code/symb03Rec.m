...
{Global`zzz$0$1[Global`t],Global`zzz$1$1[Global`t],Global`zzz$2$1[Global`t]}/.Flatten[Solve[try03RecFunc[Global`qtm1,Global`rutm1,Global`eps],{Global`zzz$2$1[Global`t],Global`zzz$1$1[Global`t],Global`zzz$0$1[Global`t]},Reals]]
igVar=Unique[];
...
If[
TimeConstrained[{symb03RecFirstSecs,igVar}=Timing[soln03Rec=Flatten[Solve[try03RecFunc[Global`qtm1,Global`rutm1,Global`eps],{Global`zzz$1$1[Global`t],Global`zzz$0$1[Global`t]}]]],Global`$MaxSolveTime]===$Aborted,
symb03RecFirstSecs=abStr]
Print["trying second solve"];
If[symb03RecFirstSecs===abStr,symb03RecSecondSecs=abStr,
{symb03RecSecondSecs,igVar}=Timing[soln03Rec=Flatten[Solve[try03RecFunc[Global`qtm1,Global`rutm1,Global`eps],{Global`zzz$2$1[Global`t],Global`zzz$1$1[Global`t],Global`zzz$0$1[Global`t]},Reals]]]];
